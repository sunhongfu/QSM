...
if ispc
    system_script=[pathstr, '\3DSRNCP_windows.exe wrapped_phase_diff.dat mask_unwrp.dat unwrapped_phase_diff.dat ', num2str(imsize(1:3))];
elseif isdeployed
    system_script = ['~/bin/3DSRNCP wrapped_phase_diff.dat mask_unwrp.dat ' ...
    'unwrapped_phase_diff.dat $nv $np $ns reliability_diff.dat'];
else
    system_script = ['${pathstr}/3DSRNCP wrapped_phase_diff.dat mask_unwrp.dat ' ...
    'unwrapped_phase_diff.dat $nv $np $ns reliability_diff.dat'];
end
