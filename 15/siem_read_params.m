function [mrdata,read_status] = siem_read_params(pathfile)
...
%     tempname2 = strcat(tempname,'meas.asc');
    ...
    %     read_n4_indicators_ver3(rawfilename, params.acq.version);  % Kelvin: Use ver3 to ignore the calculation of how many lines to read
    ...
    params.protocol_header.sKSpace.lPhaseEncodingLines = 1;
