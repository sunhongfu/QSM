function qsm_swi_prisma(path_mag, path_ph, path_out, options)
%QSM_SWI_PRISMA Quantitative susceptibility mapping from SWI sequence at PRISMA (3T).
%   QSM_SWI_PRISMA(PATH_MAG, PATH_PH, PATH_OUT, OPTIONS) reconstructs susceptibility maps.
%
...
unix('bet src/mag.nii BET -f ${bet_thr} -m -R');
