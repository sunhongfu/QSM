...
path_mag = '/home/hongfu/NCIgb5_scratch/hongfu/ed/1.10.1/1.10.1.356/1.10.1.356.1.1/1.10.1.356.1.1.34/dicom_series';
path_ph = '/home/hongfu/NCIgb5_scratch/hongfu/ed/1.10.1/1.10.1.356/1.10.1.356.1.1/1.10.1.356.1.1.35/dicom_series';
path_out = '/home/hongfu/NCIgb5/hongfu/ED/right';
...
for layers = [1 2 3]
    ...
    % QSM = MEDI_L1('lambda',500);
    % nii = make_nii(QSM.*Mask,vox);
    % save_nii(nii,['LBV/MEDI500_LBV_layers' num2str(layers) '.nii']);
    QSM = MEDI_L1('lambda',1000);
    nii = make_nii(QSM.*Mask,vox);
    save_nii(nii,['LBV/MEDI1000_LBV_layers' num2str(layers) '.nii']);
    % QSM = MEDI_L1('lambda',1500);
    % nii = make_nii(QSM.*Mask,vox);
    % save_nii(nii,['LBV/MEDI1500_LBV_layers' num2str(layers) '.nii']);
    % QSM = MEDI_L1('lambda',2000);
    % nii = make_nii(QSM.*Mask,vox);
    % save_nii(nii,['LBV/MEDI2000_LBV_layers' num2str(layers) '.nii']);
